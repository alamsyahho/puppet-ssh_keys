...
node default {
  $mysshkeyuser = hiera('ssh_keys::user', {})
  create_resources('ssh_keys::user', $mysshkeyuser)

  $mysshkeyauthkey = hiera('ssh_keys::authorized_key', {})
  create_resources('ssh_keys::authorized_key', $mysshkeyauthkey)
}
